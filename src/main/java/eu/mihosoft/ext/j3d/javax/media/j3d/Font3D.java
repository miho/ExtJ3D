 ...
 * <P>
 * A 3D Font consists of a Java 2D font, a tesellation tolerance, and an
 * extrusion path. The extrusion path creates depth by describing how the edge
 * of a glyph varies in the Z axis.
 * <P>
 * The construction of a Text3D object requires a Font3D object. The Font3D
 * object describes the style of the text, such as its depth. The text also
 * needs other classes, such as java.awt.Font and FontExtrusion. The Font object
 * describes the font name (Helvetica, Courier, etc.), the font style (bold,
 * Italic, etc.), and point size. The FontExtrusion object extends Font3D by
 * describing the extrusion path for the Font3D object (how the edge of the font
 * glyph varies in the Z axis).
 * <P>
 * To ensure correct rendering, the 2D Font object should be created with the
 * default AffineTransform. The point size of the 2D font will be used as a
 * rough measure of how fine a tesselation to use when creating the Font3D
 * object: the larger the point size, in general, the finer the tesselation.
 * <P>
 * Custom 3D fonts as well as methods to store 3D fonts to disk will be
...
// Map glyph code to GeometryArrayRetained
    ...
    /**
     * Constructs a Font3D object from the specified Font and FontExtrusion
     * objects, using the default value for the tessellation tolerance. The
     ...
     * </ul>
     * <P>
     * The FontExtrusion object contains the extrusion path to use on the 2D
     * Font glyphs. To ensure correct rendering the font must be created with
     * the default AffineTransform. Passing null for the FontExtrusion parameter
     * results in no extrusion being done.
     *
     * @param font the Java 2D font used to create the 3D font object
     * @param extrudePath the extrusion path used to describe how the edge of
     * the font varies along the Z axis
     */
    ...
    /**
     * Constructs a Font3D object from the specified Font and FontExtrusion
     * objects, using the specified tessellation tolerance. The FontExtrusion
     * object contains the extrusion path to use on the 2D Font glyphs. To
     * ensure correct rendering, the font must be created with the default
     * AffineTransform. Passing null for the FontExtrusion parameter results in
     * no extrusion being done.
     *
     * @param font the Java 2D font used to create the 3D font object.
     * @param tessellationTolerance the tessellation tolerance value used in
     * tessellating the glyphs of the 2D Font. This corresponds to the
     * <code>flatness</code> parameter in the
     * <code>java.awt.Shape.getPathIterator</code> method.
     * @param extrudePath the extrusion path used to describe how the edge of
     * the font varies along the Z axis.
     *
     * @since Java 3D 1.2
    ...
    /**
     * Copies the FontExtrusion object used to create this Font3D object into
     * the specified parameter.
     *
     * @param extrudePath object that will receive the FontExtrusion information
     * for this Font3D object
     */
    ...
    GeometryArrayRetained triangulateGlyphs(GlyphVector gv, char c) {
        ...
        if (geo == null) {
            ...
            if (fontExtrusion == null) {
                vertCnt = vertOffset;
            } else if (fontExtrusion.shape == null) {
